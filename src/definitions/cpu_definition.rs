...
impl MemoryState {
    ...
    pub fn read_bytes(&self, address: usize, num_bytes: usize) -> u32 {
        let byte_range = 0..num_bytes;
        byte_range.fold(0u32, |acc, i| {
...
mod tests {
    ...
    fn test_read_bytes_single_byte() {
        ...
        assert_eq!(mem.read_bytes(8, 1), 0b0101_1010);
    }
    ...
    fn test_read_bytes_halfword_little_endian() {
        ...
        assert_eq!(mem.read_bytes(8, 2), 0b1111_0000_1010_0101);
    }
    ...
    fn test_read_bytes_word_little_endian() {
        ...
        mem.storage[10] = 0x34;
        mem.storage[11] = 0x12;
        assert_eq!(mem.read_bytes(8, 4), 0x12345678);
    }
}
